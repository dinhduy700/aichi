    ...
    <div class="col-md-10 group-s-input">
      <div class="form-group row">
        ...
        <div class="col-sm form-inline">
          <div>
            <div class="group-flex">
              <input type="text" class="form-control size-L-uni " name="kaisyu_dt_from" style="" onchange="autoFillDate(this)">
            </div>
          </div>
          <span class="px-2"> ～ </span>
          <div>
            <div class="group-flex">
              <input type="text" class="form-control size-L-uni " name="kaisyu_dt_to" onchange="autoFillDate(this)">
            </div>
          </div>
        </div>
      </div>
