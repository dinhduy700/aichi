...
@section('js')
  ...
  <script>
    ...
    $(function() {
      exportJs.formId = 'uketsukeHaraichoExport';
      exportJs.suggestColumns = @json($columns);
      exportJs.urls.masterSuggestion = '{!! route('master-suggestion') !!}';
      exportJs.urls.validate = '{!! route('uketsuke_haraicho.exp.filterValidate') !!}';
