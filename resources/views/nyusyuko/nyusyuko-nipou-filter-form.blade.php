        ...
        <div class="form-group row mb-0">
          <div @class($rowGroupClass)>
            <div class="blockquote col-12 col-lg-12">
              <div class="row">
                <label class="col-form-label col-12 col-lg-1">基準日</label>
                <div class="col-auto d-flex flex-column">
                  <div class="group-input">
                    <input type="text" class="form-control size-L datepicker" name="exp[kijyun_dt]"
                           value="{{ \App\Helpers\Formatter::date($initValues['exp.kijyun_dt']) }}">
...
@section('js')
  ...
  <script>
    ...
    $(function() {
      ...
      exportJs.urls.validate = '{!! route('nyusyuko.nipou.nipouFilterValidate') !!}';
